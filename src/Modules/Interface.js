...
export const Interface = (() => {
    ...
    newToDo('Wake up', 'Get up now.', '23.06.1995', 'Medium', '1995-06-23', 'Daily Routine');
    newToDo('Brush teeth', 'Do it Well, do it often.', '23.06.1995', 'High', '1995-06-23', 'Daily Routine');
    newToDo('Make this app', "It won't make itself.", format(new Date(), 'dd.MM.yyyy'), 'High', '2021-05-15', 'The Odin Project');
